...
public class CoffeeAD_Adapter extends RecyclerView.Adapter<CoffeeAD_Adapter.ViewHoler> {
    ...
    private void updateDia(CoffeeAD food, int id) {
        Dialog dialog = new Dialog(context);
...
//        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        ed_listfood_size = dialog.findViewById(R.id.edt_dialog_listfood_update_size);
        ...
        ed_listfood_size.setText(list.get(id).getSize());
        ...
        for (LoaiCoffee type : listLoai) {
            if (type.getTenLoai().equals(food.getType())) {
        ...
        btnDialogAddSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CoffeeAD_DAO foodDAO1 = new CoffeeAD_DAO(context);
