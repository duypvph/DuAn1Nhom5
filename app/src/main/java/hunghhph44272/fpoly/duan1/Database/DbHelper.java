...
//            "user_name TEXT REFERENCES tbl_invoice(user_name))";
    ...
    public static final String insert_cmt = "Insert into tbl_comment(comment_content,user_name,coffee_id,rating) values" +
...
//        sqLiteDatabase.execSQL(TABLE_NOTI_CREATE);
        ...
        sqLiteDatabase.execSQL("INSERT INTO ADMIN VALUES (1,'hoanghuyhung','Hoanghung200603@gmail.com','hung123')");

        sqLiteDatabase.execSQL("INSERT INTO KHACH_HANG VALUES (1,'tancanh','0334432774','Canhdz@gmail.com','canh123')" +
                ",(2,'tancanh1','0334432775','Canhdz1@gmail.com','canh1234')" +
                ",(3,'tancanh2','0334432776','Canhdz2@gmail.com','canh1234')");
